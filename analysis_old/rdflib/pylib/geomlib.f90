...
subroutine SphereSurfaceAreas(Pos, Radii, Points, Areas, NSphere, NPoints, Dim)
    implicit none
    integer, intent(in) :: Dim
    ...
    do i = 1, NSphere
        ...
        do j = 1, NSphere
            ...
            if (sum((iPos - jPos)**2) > (Radii(i) + Radii(j))**2) cycle
            do k = 1, NPoints
...
function modulehash()
    ...
    modulehash = '070e148a766213db993820cd10f760dc5f75fbec'
end function
