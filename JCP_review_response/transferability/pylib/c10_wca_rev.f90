...
!f2py intent(in, out) :: Terms
    ...
    integer, dimension(24), parameter :: Apply3_0 = (/ 0,1,2,1,2,3,2,3,4,3,4,5,4,5,6,5,6,7,6,7,8,7,8,9 /)
...
function modulehash()
    ...
    modulehash = 'eebb5688bf943c1d773372af5fe326523b5112d7'
end function
