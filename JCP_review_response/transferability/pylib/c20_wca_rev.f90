...
!f2py intent(in, out) :: Terms
    ...
    integer, dimension(54), parameter :: Apply3_0 = (/ 0,1,2,1,2,3,2,3,4,3,4,5,4,5,6,5,6,7,6,7,8,7,8,9,8,9,10,9,10,11,10,11,12  &
...
function modulehash()
    ...
    modulehash = 'ccb34661fd704c21f19755452e86670b9fdbbbef'
end function
